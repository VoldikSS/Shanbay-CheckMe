...
!(function() {
  ...
  dispel_members_table.appendChild(
    document.querySelector('#members thead').cloneNode(true)
  )
  document
    .getElementById('dismiss_container')
    .insertBefore(dispel_members_table, members_table)
  ...
  dispel_members_table.insertBefore(
    dispel_members_table_title,
    document.querySelector('#dispel_members tbody')[0]
  )
